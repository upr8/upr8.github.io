...
The site is built with [Astro](https://astro.build/), [TypeScript](https://www.typescriptlang.org/), [Tailwind CSS](https://tailwindcss.com/), and [MDX](https://mdxjs.com/). You can see the source code on [GitHub](https://github.com/upr8/upr8.github.io).
