...
accuracy[^1], identity over inquiry.

My claim is that algorithms and GenAI shift the bottleneck from producing reasons
to producing belonging[^2], and that makes truth harder to coordinate.
...
Cognitive scientists like Hugo Mercier and Dan Sperber have argued that belief[^3]
...
when you look closely at who gets left out, silenced, or treated as a threat. [^5]
...
more replaceable, and often more detached from shared society.[^8]
